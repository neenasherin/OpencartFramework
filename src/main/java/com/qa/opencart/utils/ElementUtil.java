...
import com.qa.opencart.exceptions.ElementExceptioin;
...
public class ElementUtil {
	...
	private void nullBlankCheck(String value) {
		if (value == null || value.length() == 0) {
			throw new ElementExceptioin(value + " --- value text can not be null or blank");
		}
	}
	...
	@Step("getting webelement using locator {0}")
...
@Step("getting the locator {0} and value {1}")
	public void doSendKeys(By locator, String value) {
		nullBlankCheck(value);
		getElement(locator).clear();
		getElement(locator).sendKeys(value);
	}
@Step("getting the locator {0} and value {1} and tomeout{2}")
	public void doSendKeys(By locator, String value, int timeOut) {
		nullBlankCheck(value);
		waitForElementVisible(locator, timeOut).sendKeys(value);
	}
@Step("getting the locatortype {0} and loactorvalue {1} and value {2}")
	public void doSendKeys(String locatorType, String locatorValue, String value) {
		getElement(locatorType, locatorValue).sendKeys(value);
	}
@Step("getting the locator {0} for click")
	public void doClick(By locator) {
		getElement(locator).click();
	}
@Step("getting the locator {0} and tomeout {1} for click")
	public void doClick(By locator, int timeOut) {
		waitForElementVisible(locator, timeOut).click();
	}
@Step("elementlocator by text {0}")
	public String doGetElementText(By locator) {
		return getElement(locator).getText();
	}
@Step("element attribute by locator {0} and attributename {1}")
	...
	@Step("get list of web Element by loactor {0}")
	...
	@Step("get Element txt list of the loactor {0}")
	...
	public void doSelectByVisibleText(By locator, String visibleText) {
		...
		try {
			...
			e.printStackTrace();
			throw new ElementExceptioin("text not present");
		}
	 ...
	 */
	@Step("Wait for elemtn visible by locator {0} and timeout {1}")
	public List<WebElement> waitForElementsVisible(By locator, int timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
		return wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(locator));
	}
	
	@Step("waitForTitleContains by titleFraction {0} and timeout {1}")
...
@Step("waiting for expected  url")
	...
	public WebElement retryingElement(By locator, int timeOut) {
		...
		if(element == null) {
			...
			throw new ElementExceptioin("No Such Element");
		}
		return element;
